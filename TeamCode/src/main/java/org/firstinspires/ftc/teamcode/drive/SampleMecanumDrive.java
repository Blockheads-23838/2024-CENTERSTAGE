...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public double getRawExternalHeading() {
        return imu.getRobotYawPitchRollAngles().getYaw(AngleUnit.RADIANS) * 360/365; //LHACK: since the heading was consistently off by that much
    }

    @Override
    public Double getExternalHeadingVelocity() {
        return (double) imu.getRobotAngularVelocity(AngleUnit.RADIANS).zRotationRate * 360/365;
    }
